...
public class RegistryCollection<T extends Block> {
    ...
    private final Block.Properties blkProp;
    ...
    public static RegistryCollection create(final String name,
                                            final Block.Properties blockProperties,
    ...
    public RegistryCollection<T> init(final Supplier<T> blkConstructor, final DeferredRegister<Block> blkReg, final DeferredRegister<Item> itemReg) {
        ...
        this.SLAB_BLOCK = new RegistryPair(
                blkReg.register(this.name + "_slab",
                        () -> new SlabBlock(Block.Properties.from(this.BASE_BLOCK.getBlock().get()))),
                item,
                itemReg);
    ...
    public T getBase() {
        return getBaseBlock().getBlock().get();
    }
    ...
    public <I extends StairsBlock> I getStairs() {
        return (I) getStairsBlock().getBlock().get();
    }
    ...
    public <J extends SlabBlock> J getSlab() {
        return (J) getSlabBlock().getBlock().get();
    }
    ...
    public <K extends SideSlabBlock> K getSideSlab() {
        return (K) getSideSlabBlock().getBlock().get();
    }
