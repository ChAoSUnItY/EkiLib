...
public class TicketGateBlock extends HorizontalBaseBlock {
    ...
    public static final HorizontalVoxelShapes COLLISION_UNOPENED_SHAPES = new HorizontalVoxelShapes(
            Stream.of(
                    Block.makeCuboidShape(0.5, 3, 0.25, 2.5, 12.75, 15.75),
                    Block.makeCuboidShape(0.5, 0, 2, 3, 3, 14),
                    Block.makeCuboidShape(15.5, 12.75, 0, 16, 24, 16),
    ...
    public static final HorizontalVoxelShapes COLLISION_OPENED_SHAPES = new HorizontalVoxelShapes(
            Stream.of(
                    Block.makeCuboidShape(2.75, 6, 9.25, 3.25, 11, 15.75),
                    Block.makeCuboidShape(15.25, 6, 9.25, 15.75, 11, 15.75),
                    Block.makeCuboidShape(0.5, 3, 0.25, 2.5, 12.75, 15.75),
            ...
            if (stack.getItem() instanceof StationTunerItem) {
                ...
                if (nbt.contains(UtilStationConverter.POSITION)) {
                    ...
                    player.sendStatusMessage(new TranslationTextComponent("eki_lib.message.station_bind")
                            .appendSibling(new StringTextComponent(TGte.getStation().getName()).applyTextStyle(TextFormatting.BOLD))
                    ...
                    if (hit.getFace() == Direction.UP || hit.getFace() == state.get(FACING)) {
                        ...
                        if (nbt.contains("startPos")) {
                            ...
                            if (value >= requiredPrice) {
                                ...
                                ITextComponent
                                        subtext = new TranslationTextComponent("eki_lib.message.unknown_station").applyTextStyles(TextFormatting.ITALIC, TextFormatting.GRAY),
                                        from = nbt.contains("fromStation") ? new StringTextComponent(nbt.getString("fromStation")).applyTextStyle(TextFormatting.BOLD) : new TranslationTextComponent("eki_lib.message.unknown_station").applyTextStyles(TextFormatting.ITALIC, TextFormatting.GRAY);
                                if (TGte.hasStationPos())
                                    player.sendStatusMessage(new TranslationTextComponent("eki_lib.message.exit", new StringTextComponent(TGte.getStation().getName()).applyTextStyle(TextFormatting.BOLD), from).applyTextStyle(TextFormatting.GREEN), true);
                                else
                                    player.sendStatusMessage(new TranslationTextComponent("eki_lib.message.exit", subtext, from).applyTextStyle(TextFormatting.GREEN), true);
    ...
    public VoxelShape getCollisionShape(BlockState state, IBlockReader worldIn, BlockPos pos, ISelectionContext context) {
        return state.get(OPEN) ? COLLISION_OPENED_SHAPES.getByDirection(state.get(FACING)) : COLLISION_UNOPENED_SHAPES.getByDirection(state.get(FACING));
    }
