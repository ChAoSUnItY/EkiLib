...
public class TicketVendorScreen extends ContainerScreen<TicketVendorContainer> {
    ...
    protected void init() {
        ...
        this.clearButton = this.addButton(new Button(
                ...
                50,
                20,
                new TranslationTextComponent("eki_lib.screen.clear").getFormattedText(),
        ...
        this.confirmedButton = this.addButton(new Button(
                ...
                50,
                20,
                new TranslationTextComponent("eki_lib.screen.confirmed").getFormattedText(),
                v -> {
        ...
        this.priceInputTextField = new TextFieldWidget(this.font,
                ...
                117,
                13,
                new StringTextComponent("").getFormattedText());
    ...
    public void render(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.priceInputTextField.render(mouseX, mouseY, partialTicks);
